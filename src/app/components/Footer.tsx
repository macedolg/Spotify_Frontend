...
export function Footer(){
    return(
        ...
        <Image src="/kayblack.jpg" width={56} height={56} alt="Capa do Album KayBlack" />
        <div className='flex flex-col'>
          <strong className='font-normal'>Desejos</strong>
        ...
        <div className='flex items-center gap-2'>
          ...
          <span className='text-xs text-zinc-500'>2:07</span>
        </div>
        </div>
        <div>
          <div className='flex items-center gap-4'>
